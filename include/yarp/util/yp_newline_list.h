...
bool yp_newline_list_init(yp_allocator_t *allocator, yp_newline_list_t *list, const char *start, size_t capacity);

// Append a new offset to the newline list. Returns true if the reallocation of
// the offsets succeeds (if one was necessary), otherwise returns false.
bool yp_newline_list_append(yp_allocator_t *allocator, yp_newline_list_t *list, const char *cursor);

// Conditionally append a new offset to the newline list, if the value passed in is a newline.
bool yp_newline_list_check_append(yp_allocator_t *allocator, yp_newline_list_t *list, const char *cursor);
